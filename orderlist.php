...
?>
  ...
  <div class="content-wrapper">  
    ...
    <?php
                   $select=$pdo->prepare("select * from tbl_invoice where location_id='".$_SESSION['location_id']."' order by invoice_id desc");
                    // print_r($select);
                    // die();
                   $select->execute();
                ...
                while($row=$select->fetch(PDO::FETCH_OBJ)){
                    ...
                    // if(!($row->customer_phonenumber==""){
                    //     $phonenumber = $row->customer_phonenumber; //"(".$row->customer_phonenumber.")"
                    // }else{
                    //     $phonenumber="";
                    // }
                  ...
                  <td>'.$row->customer_name.' '.$phonenumber.'</td>
