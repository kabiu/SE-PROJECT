  ...
  <div class="content-wrapper">  
   ...
   <div class="box box-warning">
            <div class="box-header with-border">
              ...
              <div style="float: right;">
                  <a href="#" class="btn btn-success"> 
                    <span class="fa fa-plus" style="color:#ffffff; margin-right:10px"></span>New Recipe
                  </a>
              </div>
            </div>
            <!-- /.box-header -->
      ...
      <table id="transferstable" class="table table-striped">
              ...
              <?php
               $select=$pdo->prepare("select * from tbl_recipes left join tbl_product on tbl_recipes.product_id = tbl_product.pid order by id desc ");
               ...
               $select->execute();
                ...
                while($row=$select->fetch(PDO::FETCH_OBJ)){
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="view-recipe.php?id='.$row->id.'" class="btn btn-success" role="button">
