...
while($row=$select->fetch(PDO::FETCH_OBJ)){
 ...
 <ul class="list-group">
 <centre><p class="list-group-item list-group-item-success"><b>Product Detail</b></p></centre>
  ...
  <li class="list-group-item"><b>Sale Price</b><span class="label label-info pull-right">'.$row->saleprice.'</span></li>
  ...
  <li class="list-group-item"><b>Stock</b><span class="label label-danger pull-right">'.$quantity.'</span></li>
...
<div class="col-md-6">
 ...
 <ul class="list-group">
 <centre><p class="list-group-item list-group-item-success"><b>Product Image</b></p></centre>
