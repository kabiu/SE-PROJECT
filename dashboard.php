...
$select = $pdo->prepare("select sum(total) as t , count(invoice_id) as inv from tbl_invoice where location_id='".$_SESSION['location_id']."' ");
$select->execute();
            ...
            <div class="box-body">
              ...
              <table id="bestsellingproductlist" class="table table-striped">
                ...
                <tbody>
                  ...
                  <?php
                   $select=$pdo->prepare("select product_id,product_name,price,sum(qty) as q , sum(qty*price) as total from tbl_invoice_details where location_id=".$_SESSION['location_id']." group by product_id order by sum(qty) DESC LIMIT 15");
            ...
            <div class="box-body">
              ...
              <table id="orderlisttable" class="table table-striped">
                ...
                <tbody>
                  ...
                  <?php
                   $select=$pdo->prepare("select * from tbl_invoice where location_id=".$_SESSION['location_id']." order by invoice_id desc LIMIT 15");
