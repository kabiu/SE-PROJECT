...
<!--       <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php echo ($us_page_title == 'pos') ? ' active' : ''; ?>">
          <a href="createorder.php"><i class="fa fa-first-order"></i><span>Make Sale</span></a
            ></li>
          
        <li class="<?php echo ($us_page_title == 'sales') ? ' active' : ''; ?>">
          <a href="usersales.php"><i class="fa fa-list-ul"></i> <span>Sales List</span></a>
        </li>  

        <li class="<?php echo ($us_page_title == 'inventory') ? ' active' : ''; ?>">
          <a href="productlist.php"><i class="fa fa-database"></i> <span>Inventory</span></a>
        </li>  
