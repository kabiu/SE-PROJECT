    ...
    <section class="content container-fluid">
        ...
        <div class="box box-warning">
            <form action="" method="post" name="">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title custom">
                        From:(<span> <?php echo $_POST['date_1']?> </span>)

                        To:(<span> <?php echo $_POST['date_2']?> </span>)
          ...
          <input type="text" class="form-control pull-right" id="datepicker1" name="date_1"
                                    data-date-format="yyyy-mm-dd" value="<?php echo $_POST['date_1']?>">
                            </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="datepicker2" name="date_2"
                                    data-date-format="yyyy-mm-dd" value="<?php echo $_POST['date_2']?>">
                            </div>
